...
namespace Employees_ICS {
    ...
    public partial class TestDBDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeesRow AddemployeesRow(string firstName, string lastName, string position, System.DateTime dateBirth, int salary) {
...
namespace Employees_ICS.TestDBDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[employees] ([firstName], [lastName], [position], [dateBirth], [salary]) VALUES (@firstName, @lastName, @position, @dateBirth, @salary);
SELECT id, firstName, lastName, position, dateBirth, salary FROM employees WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [firstName] = @firstName, [lastName] = @lastName, [position] = @position, [dateBirth] = @dateBirth, [salary] = @salary WHERE (([id] = @Original_id) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)) AND ([position] = @Original_position) AND ([dateBirth] = @Original_dateBirth) AND ([salary] = @Original_salary));
SELECT id, firstName, lastName, position, dateBirth, salary FROM employees WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Employees_ICS.Properties.Settings.Default.TestDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstName, lastName, position, dateBirth, salary FROM dbo.employees";
        ...
        public virtual int Delete(int Original_id, string Original_firstName, string Original_lastName, string Original_position, System.DateTime Original_dateBirth, int Original_salary) {
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((System.DateTime)(Original_dateBirth));
        ...
        public virtual int Insert(string firstName, string lastName, string position, System.DateTime dateBirth, int salary) {
            if ((firstName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(dateBirth));
        ...
        public virtual int Update(string firstName, string lastName, string position, System.DateTime dateBirth, int salary, int Original_id, string Original_firstName, string Original_lastName, string Original_position, System.DateTime Original_dateBirth, int Original_salary, int id) {
            if ((firstName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(dateBirth));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string position, System.DateTime dateBirth, int salary, int Original_id, string Original_firstName, string Original_lastName, string Original_position, System.DateTime Original_dateBirth, int Original_salary) {
            return this.Update(firstName, lastName, position, dateBirth, salary, Original_id, Original_firstName, Original_lastName, Original_position, Original_dateBirth, Original_salary, Original_id);
        }
    }
